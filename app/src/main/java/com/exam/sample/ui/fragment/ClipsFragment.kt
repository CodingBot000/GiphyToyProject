...
class ClipsFragment : BaseFragment<FragmentClipsBinding, ClipsViewModel>(), SwipeRefreshLayout.OnRefreshListener {
    ...
    private val viewModel by viewModels<ClipsViewModel>()
    ...
    override fun init() {
        ...
        binding.apply {
            swipeLayout.setOnRefreshListener(this@ClipsFragment)
            recyclerView.apply {
    ...
    override fun onRefresh() {
        ...
        binding.root.delayOnLifecycle(500L) {
            viewModel.getClipsData(getString(Const.TAB_TITLES[2]))
    ...
    private fun initData() {
        viewModel.apply {
            getClipsData(getString(Const.TAB_TITLES[2]))
        }
    }
