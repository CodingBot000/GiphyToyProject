...
import com.exam.sample.model.repository.search.ArtistPagingRepository
...
class ArtistsViewModel @Inject constructor(
    private val artistPagingRepository: ArtistPagingRepository
) : BaseViewModel()
{
    ...
    fun getArtistsData(keyword: String) {
        ...
        job = viewModelScope.launch {
            dataFlow = artistPagingRepository.getPagingData(keyword)
